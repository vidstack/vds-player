 ...
 */
export function provideContextRecord<ContextRecordType extends import("./types").ContextRecord<unknown>>(host: import('./types').ContextHost, contextRecord: ContextRecordType): import("./types").ExtractContextRecordTypes<import("../../utils.js").ReadonlyIfType<import("./types").DerivedContext<any>, ContextRecordType>>;
