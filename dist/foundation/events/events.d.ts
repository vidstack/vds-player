 ...
 * ```
 */
export function listen<ListenedEvent extends Event>(target: EventTarget, type: string, listener: (event: ListenedEvent) => void, options?: boolean | AddEventListenerOptions | EventListenerOptions | undefined): () => void;
/**
 * Listens to an event on the given `target` and returns a cleanup function to stop listening.
 *
 ...
 */
export function listenGlobalEvent<EventType extends keyof GlobalEventHandlersEventMap>(target: EventTarget, type: EventType, listener: (event: GlobalEventHandlersEventMap[EventType]) => void, options?: boolean | AddEventListenerOptions | EventListenerOptions | undefined): () => void;
/**
 * @typedef {{
 ...
 */
export function isVdsEvent(event?: Event | undefined): event is VdsCustomEvent<unknown>;
/**
 * @template DetailType
 * @typedef {{
...
export type EventHandlerRecord = {
    ...
    "vds-scrubber-preview-connect"?: ((event: import("../../bundle").ScrubberPreviewConnectEvent) => void) | undefined;
    ...
    "vds-hls-load"?: ((event: import("../../bundle").HlsLoadEvent) => void) | undefined;
    "vds-hls-load-error"?: ((event: import("../../bundle").HlsLoadErrorEvent) => void) | undefined;
    "vds-hls-build"?: ((event: import("../../bundle").HlsBuildEvent) => void) | undefined;
    "vds-hls-detach"?: ((event: import("../../bundle").HlsDetachEvent) => void) | undefined;
    "vds-hls-attach"?: ((event: import("../../bundle").HlsAttachEvent) => void) | undefined;
    "vds-hls-no-support"?: ((event: import("../../bundle").HlsNoSupportEvent) => void) | undefined;
