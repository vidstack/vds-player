...
export class MediaContainerConnectEvent extends DiscoveryEvent<MediaContainerElement> {
    ...
    constructor(eventInit?: import("../../foundation/events/events.js").VdsEventInit<import("../../foundation/elements/index.js").DiscoveryEventDetail<MediaContainerElement>> | undefined, type?: string | undefined, final?: boolean | undefined); /** @type {string[]} */
}
/**
