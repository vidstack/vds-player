 ...
 */
export function getConstructor<T>(value: unknown): import("../utils").Constructor<T>;
/**
 ...
 * @returns {boolean}
 */
export function isInstanceOf(value: unknown, constructor: import("../utils").Constructor<unknown>): boolean;
/**
 ...
 * @returns {boolean}
 */
export function isPrototypeOf(value: object, object: import("../utils").Constructor<unknown>): boolean;
