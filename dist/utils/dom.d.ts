 ...
 */
export function raf(callback?: (() => void) | undefined): Promise<number>;
/**
 ...
 * @returns {string}
 */
export function buildExportPartsAttr(parts: string[], prefix?: string | ((part: string) => string) | undefined): string;
/**
